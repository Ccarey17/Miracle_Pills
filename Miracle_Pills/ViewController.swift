...
//  Miracle_Pills
//
//  Created by Christopher Carey on 7/13/17.
//  Copyright © 2017 Christopher Carey. All rights reserved.
//
...
class ViewController: UIViewController, UIPickerViewDataSource,UIPickerViewDelegate{
    ...
    let states = ["Alaska","Alabama","Arkansas","American Samoa","Arizona","California","Colorado",
